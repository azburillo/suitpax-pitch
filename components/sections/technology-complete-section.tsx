...
export default function TechnologyCompleteSection() {
  return (
    ...
    >
      ...
      <h3 className="text-xl sm:text-2xl md:text-3xl font-medium tracking-tighter mb-4 sm:mb-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
            <h4 className="text-lg font-medium tracking-tighter mb-3 flex items-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <p className="text-xs font-light text-gray-700">Identity platform & authentication</p>
              </div>
              <div className="bg-gray-50 p-3 rounded-lg">
        ...
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                <p className="text-sm font-medium">Claude Opus 4</p>
                <p className="text-xs font-light text-gray-700">Next-gen language models</p>
              </div>
              <div className="bg-gray-50 p-3 rounded-lg">
