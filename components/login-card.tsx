...
// Update the LoginCard props interface to remove onShowChat
interface LoginCardProps {
  onUnlock: () => void
}

// Update the function signature to remove onShowChat
export default function LoginCard({ onUnlock }: LoginCardProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="relative z-10 flex justify-center mb-3 sm:mb-6">
        <Image src="/suitpax-white-logo.png" alt="Suitpax Logo" width={140} height={35} className="h-6 sm:h-8 w-auto" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="relative z-10 space-y-4 sm:space-y-5">
        <div className="bg-black/40 backdrop-blur-md border border-white/20 rounded-2xl p-3 sm:p-5">
          ...
          <p className="text-white/90 text-sm sm:text-base mb-3 sm:mb-5 font-medium">
            Hey guys! I'm Zia, an AI-Agent from Suitpax. What company are you representing today?
          </p>
